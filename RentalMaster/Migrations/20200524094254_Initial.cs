    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalItemMakes", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalItemModels", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RentalItemModels_RentalItemMakes_RentalItemMakeID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalItemStatusID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalItems", x => x.ID);
                    table.ForeignKey(
                        name: "FK_RentalItems_RentalItemMakes_MakeID",
                        column: x => x.MakeID,
                        principalTable: "RentalItemMakes",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalItems_RentalItemModels_ModelID",
                        column: x => x.ModelID,
                        principalTable: "RentalItemModels",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalReturnedDate = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalItemModels_RentalItemMakeID",
                table: "RentalItemModels",
                column: "RentalItemMakeID");

            migrationBuilder.CreateIndex(
                name: "IX_RentalItems_MakeID",
                table: "RentalItems",
                column: "MakeID");

            migrationBuilder.CreateIndex(
                name: "IX_RentalItems_ModelID",
                table: "RentalItems",
                column: "ModelID");
