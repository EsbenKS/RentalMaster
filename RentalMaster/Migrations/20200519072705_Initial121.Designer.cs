...
namespace RentalMaster.Migrations
{
    ...
    [Migration("20200519072705_Initial121")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentalMaster.Models.RentalItem", b =>
                {
                    ...
                    b.Property<int?>("RentalItemCategoryID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RentalItemCategoryID");
            ...
            modelBuilder.Entity("RentalMaster.Models.RentalItemCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RentalItemCategories");
                });
            ...
            modelBuilder.Entity("RentalMaster.Models.RentalItem", b =>
                {
                    b.HasOne("RentalMaster.Models.RentalItemCategory", "RentalItemCategory")
                        .WithMany()
                        .HasForeignKey("RentalItemCategoryID");
            ...
            modelBuilder.Entity("RentalMaster.Models.RentalItemMake", b =>
                {
                    b.HasOne("RentalMaster.Models.RentalItemCategory", null)
                        .WithMany("RentalItemMakes")
                        .HasForeignKey("RentalItemCategoryID");
                });
